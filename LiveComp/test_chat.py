...
# アクセストークン
TOKEN = "1916073125:AAH72XaNI7EfNxEa3mEQt8upFLXgs7EGZK0"
...
class SampleBot:
    def __init__(self):
        ...
        path = "./rule.json"
        name = "test"
        self.generator = Generator(name, path)
    ...
    def start(self, bot, update):
        ...
        update.message.reply_text('湯川先輩，少しよろしいですか？')
    ...
    def message(self, bot, update):
        ...
        send_message = self.generator.reply(self.user_context[update.message.from_user.id]["context"])
